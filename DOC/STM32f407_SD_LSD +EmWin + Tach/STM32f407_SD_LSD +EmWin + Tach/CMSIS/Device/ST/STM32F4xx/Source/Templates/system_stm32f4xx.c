...
/************************* PLL Parameters *************************************/
/* PLL_VCO = (HSE_VALUE or HSI_VALUE / PLL_M) * PLL_N */ // 192MHz < f_VCO < 432MHz  (212)
#define PLL_M      8 // M = from 2 to 63.  
/* USB OTG FS, SDIO and RNG Clock =  PLL_VCO / PLLQ */
#define PLL_Q      7

#if defined (STM32F40_41xxx)
#define PLL_N      336 // N = from 192 to  432 (223) 
/* SYSCLK = PLL_VCO / PLL_P */
#define PLL_P      2 // P=2,4,6,8
