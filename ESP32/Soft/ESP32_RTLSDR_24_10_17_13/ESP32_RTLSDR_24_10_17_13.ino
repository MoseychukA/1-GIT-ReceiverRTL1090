...
//===========================================================================
static const char* TAG_ADSB2 = "ADSB2";
...
static void client_event_cb(const usb_host_client_event_msg_t* event_msg, void* arg)
{
    ...
    case USB_HOST_CLIENT_EVENT_NEW_DEV:
        if (driver_obj->dev_addr == 0)
        {
            ...
            int n_read = 2;
            ESP_LOGI(TAG_ADSB2, "[APP] Free memory: %ld bytes", esp_get_free_heap_size());
...
static void action_open_dev(class_driver_t* driver_obj)
{
    ...
    ESP_LOGI(TAG_ADSB2, "Opening device at address %d", driver_obj->dev_addr);
...
static void action_get_info(class_driver_t* driver_obj)
{
    ESP_LOGI(TAG_ADSB2, "here2");
    assert(driver_obj->dev_hdl != NULL);
    ESP_LOGI(TAG_ADSB2, "Getting device information");
    usb_device_info_t dev_info;
    ESP_ERROR_CHECK(usb_host_device_info(driver_obj->dev_hdl, &dev_info));
    ESP_LOGI(TAG_ADSB2, "\t%s speed", (dev_info.speed == USB_SPEED_LOW) ? "Low" : "Full");
    ESP_LOGI(TAG_ADSB2, "\tbConfigurationValue %d", dev_info.bConfigurationValue);
...
{
    assert(driver_obj->dev_hdl != NULL);
    ESP_LOGI(TAG_ADSB2, "Getting device descriptor");
...
{
    assert(driver_obj->dev_hdl != NULL);
    ESP_LOGI(TAG_ADSB2, "Getting config descriptor");
...
static void action_get_str_desc(class_driver_t* driver_obj)
{
    ...
    {
        ESP_LOGI(TAG_ADSB2, "Getting Manufacturer string descriptor");
        usb_print_string_descriptor(dev_info.str_desc_manufacturer);
    }
    if (dev_info.str_desc_product)
    {
        ESP_LOGI(TAG_ADSB2, "Getting Product string descriptor");
        usb_print_string_descriptor(dev_info.str_desc_product);
    }
    if (dev_info.str_desc_serial_num)
    {
        ESP_LOGI(TAG_ADSB2, "Getting Serial Number string descriptor");
