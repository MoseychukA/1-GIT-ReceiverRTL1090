...
int rtlsdr_open(rtlsdr_dev_t **out_dev, uint8_t index, usb_host_client_handle_t client_hdl)
{
   ...
   // ESP_LOGI(TAG_ADSB, " ***rtldev1 %d", (int)rtldev);
    ESP_LOGI(TAG_ADSB, "*** new_dev.address1 %d ", index);
    ESP_LOGI(TAG_ADSB, "*** client_hdl1 %d", driver_obj->client_hdl);
    ...
    ESP_LOGI(TAG_ADSB, "*** client_hdl2 %d", driver_obj->client_hdl);
