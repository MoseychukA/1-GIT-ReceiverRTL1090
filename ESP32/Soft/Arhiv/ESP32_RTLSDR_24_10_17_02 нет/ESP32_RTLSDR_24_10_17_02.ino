...
static const char* TAG_ADSB_LIB = "ADSB_LIB";
...
void host_lib_daemon_task(void* arg) // Настройка USB порта
{
...
void init_adsb_dev()
{
   // adsbdev = calloc(1, sizeof(class_adsb_dev));
    adsbdev->response_buf = (uint8_t*)calloc(1/*sizePacket*/, sizeof(uint8_t));
