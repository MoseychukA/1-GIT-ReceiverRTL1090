...
static void host_lib_daemon_task(void* arg)
{
    ...
    while (has_clients || has_devices)
    {
       ...
       // ESP_LOGI(TAG, "has_clients , has_devices\n");  // Больше никаких клиентов и устройств
        esp_task_wdt_reset();
    }
    ESP_LOGI(TAG, "No more clients and devices");  // Больше никаких клиентов и устройств
...
static void client_event_cb(const usb_host_client_event_msg_t* event_msg, void* arg)
{
    ...
    case USB_HOST_CLIENT_EVENT_NEW_DEV:
        if (driver_obj->dev_addr == 0)
        {
            ...
            uint32_t out_block_size = 16384;//DEFAULT_BUF_LENGTH;
...
//{
//    SemaphoreHandle_t signaling_sem = (SemaphoreHandle_t)arg;
//    class_driver_t driver_obj_class = { 0 };
//
//    // Wait until daemon task has installed USB Host Library
//    xSemaphoreTake(signaling_sem, portMAX_DELAY);
//
...
//        .async = {
//            .client_event_callback = client_event_cb,
//            .callback_arg = (void*)&driver_obj_class,
//        },
//    };
//    ESP_ERROR_CHECK(usb_host_client_register(&client_config, &driver_obj_class.client_hdl));
//
//    while (1)
//    {
//        if (driver_obj_class.actions == 0)
//        {
//            usb_host_client_handle_events(driver_obj_class.client_hdl, portMAX_DELAY);
//        }
//        else
//        {
//            if (driver_obj_class.actions & ACTION_OPEN_DEV)
//            {
//                action_open_dev(&driver_obj_class);
//            }
//            if (driver_obj_class.actions & ACTION_GET_DEV_INFO)
//            {
//                action_get_info(&driver_obj_class);
//            }
//            if (driver_obj_class.actions & ACTION_GET_DEV_DESC)
//            {
//                action_get_dev_desc(&driver_obj_class);
//                //action_get_dev_desc1(&driver_obj_class);
//            }
//            if (driver_obj_class.actions & ACTION_GET_CONFIG_DESC)
//            {
//                action_get_config_desc(&driver_obj_class);
//            }
//            if (driver_obj_class.actions & ACTION_GET_STR_DESC)
//            {
//                action_get_str_desc(&driver_obj_class);
//            }
//            if (driver_obj_class.actions & ACTION_CLOSE_DEV) 
//            {
//                aciton_close_dev(&driver_obj_class);
//            }
//            if (driver_obj_class.actions & ACTION_EXIT)
//            {
//                break;
//            }
//        }
...
//    ESP_ERROR_CHECK(usb_host_client_deregister(driver_obj_class.client_hdl));
//
//    // Wait to be deleted
//    xSemaphoreGive(signaling_sem);
//    vTaskSuspend(NULL);
