...
static void client_event_cb(const usb_host_client_event_msg_t* event_msg, void* arg)
{
    ...
    case USB_HOST_CLIENT_EVENT_NEW_DEV:
        if (driver_obj->dev_addr == 0)
        {
            ...
            Serial.print("*** rtldev "); Serial.println((int)rtldev);
            Serial.print("*** new_dev.address "); Serial.println(event_msg->new_dev.address);
            Serial.print("*** client_hdl "); Serial.println((int)driver_obj->client_hdl);
