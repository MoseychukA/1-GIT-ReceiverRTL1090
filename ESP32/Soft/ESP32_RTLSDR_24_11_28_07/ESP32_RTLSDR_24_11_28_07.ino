...
int rtlsdr_open(rtlsdr_dev_t** out_dev, uint8_t index, usb_host_client_handle_t client_hdl)
{
   ...
   // dev = (rtlsdr_dev_t*)malloc(sizeof(rtlsdr_dev_t));
    ...
    Serial.print("*** rtldev1 "); Serial.println((int)rtldev);
    Serial.print("*** new_dev.address1 "); Serial.println(index);
    Serial.print("*** client_hdl1 "); Serial.println((int)driver_obj->client_hdl);
